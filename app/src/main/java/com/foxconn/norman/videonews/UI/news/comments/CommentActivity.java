...
import com.foxconn.norman.videonews.Bobmapi.other.NewsApi;
...
import com.foxconn.norman.videoplayer.part.SimpleVideoPlayer;
...
public class CommentActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.menu_item_like){
            ...
            NewsApi newsApi_cloud = BombClient.getBombClient().getNewsApi_cloud();
